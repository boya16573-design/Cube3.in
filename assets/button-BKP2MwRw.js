...
var MESSAGES = {
	en: {
		...
		"home.h1a": "Find sponsorships. Find creators.",
		"home.h1b": "Build collaborations.",
		"home.sub": "Cube3 helps creators discover relevant sponsorship opportunities and helps brands find creators who match their campaigns — anywhere in the world.",
		"home.findSponsorships": "Find Sponsorships",
		"home.findCreators": "Find Creators",
		"home.imCreator": "I'm a Creator →",
		"home.imBrand": "I'm a Brand →",
		"home.forCreators": "For creators",
		"home.forCreatorsBody": "Connect your channel. Cube3 surfaces sponsorships that match your audience and content.",
		"home.forBrands": "For brands",
		"home.forBrandsBody": "Create a campaign. Cube3 finds creators who match your audience, category and requirements.",
		"flow.creator": "Creator",
		"flow.brand": "Brand",
		"flow.discover": "Discover",
		"flow.apply": "Apply",
		"flow.collaborate": "Collaborate",
		"flow.getPaid": "Get Paid",
		"flow.campaign": "Campaign",
		"flow.grow": "Grow",
		"home.d1t": "Sponsorships for you",
		"home.d1b": "Open Cube3 and see campaigns matched to your category, platform, audience and language.",
		"home.d2t": "Explained matches",
		"home.d2b": "Every match score shows exactly which requirements you meet — no black-box AI numbers.",
		"home.d3t": "Honest data",
		"home.d3b": "Verified and creator-reported stats are always labelled separately. Small creators welcome.",
		"home.faqQ": "How do I find sponsors for my YouTube channel?",
		"home.faqA": "Add your channel. Cube3 finds sponsorship opportunities that match your audience and content. Apply, negotiate and collaborate.",
		"home.getStarted": "Get started free",
		"footer.privacy": "Privacy",
		"footer.terms": "Terms",
		"signin.titleCreator": "Join Cube3 as a creator",
		"signin.titleBrand": "Join Cube3 as a brand",
		"signin.title": "Sign in to Cube3",
		"signin.sub": "No passwords. We'll email you a one-time code — this also verifies your email.",
		"signin.agree": "By continuing you agree to our Terms and Privacy Policy. Cube3 is for people aged 18+.",
		"signin.email": "Email",
		"signin.sendCode": "Send code",
		"signin.sending": "Sending…",
		"signin.codeLabel": "6-digit code sent to {email}",
		"signin.verify": "Verify & continue",
		"signin.verifying": "Verifying…",
		"signin.otherEmail": "Use a different email",
		"sp.title": "Find Sponsorships",
		"sp.sub": "Open campaigns from brands looking for creators.",
		"sp.forYou": "For you",
		"sp.all": "All campaigns",
		"sp.getMatched": "Sign up as a creator to see which campaigns match you — and why.",
		"sp.getMatchedCta": "Get matched",
		"sp.matchCount": "{n} campaigns match your profile",
		"sp.noMatches": "No matches right now",
		"sp.noMatchesBody": "Add platforms and audience stats to your profile to unlock matches.",
		"sp.completeProfile": "Complete profile →",
		"sp.search": "Search brand, product, location…",
		"sp.allCategories": "All categories",
		"sp.noOpen": "No open campaigns found",
		"sp.loadMore": "Load more campaigns",
		"card.view": "View campaign",
		"card.apply": "Apply",
		"card.applied": "Applied",
		"card.whyMatch": "Why you match",
		"card.match": "{n}% match",
		"card.audience": "{n}+ audience",
		"cr.title": "Find Creators",
		"cr.sub": "Small and mid-size creators welcome. Open a campaign to see ranked matches.",
		"cr.search": "Search name, category, city, language…",
		"cr.filters": "Filters",
		"cr.none": "No creators found",
		"cr.loadMore": "Load more creators",
		"cr.viewProfile": "View profile",
		"db.sponsorshipsForYou": "Sponsorships for you",
		"db.seeAll": "See all →",
		"db.yourApplications": "Your applications",
		"db.noApplications": "You haven't applied to a campaign yet.",
		"db.findSponsorships": "Find Sponsorships →",
		"db.addPlatformTitle": "Add your YouTube or Instagram to get matched",
		"db.addPlatformBody": "Cube3 matches you using your platforms, audience size and views.",
		"db.addPlatform": "Add a platform →",
		"db.noMatchesYet": "No matching campaigns yet",
		"db.browse": "Browse sponsorships →",
		"db.brandOverview": "Brand overview",
		"db.newCampaign": "New campaign",
		"db.yourCampaigns": "Your campaigns",
		"db.firstCampaign": "Create your first campaign to start receiving applications.",
		"db.createCampaign": "Create campaign →"
	},
	hi: {
		"nav.home": "होम",
		"nav.sponsorships": "स्पॉन्सरशिप",
		"nav.creators": "क्रिएटर्स",
		"nav.inbox": "इनबॉक्स",
		...
		"nav.language": "भाषा",
		"home.h1a": "स्पॉन्सरशिप खोजें। क्रिएटर्स खोजें।",
		"home.h1b": "साथ मिलकर काम करें।",
		"home.sub": "Cube3 क्रिएटर्स को सही स्पॉन्सरशिप ढूँढने और ब्रांड्स को अपने कैंपेन के लिए सही क्रिएटर्स खोजने में मदद करता है — दुनिया में कहीं भी।",
		"home.findSponsorships": "स्पॉन्सरशिप खोजें",
		"home.findCreators": "क्रिएटर्स खोजें",
		"home.imCreator": "मैं क्रिएटर हूँ →",
		"home.imBrand": "मैं ब्रांड हूँ →",
		"home.forCreators": "क्रिएटर्स के लिए",
		"home.forCreatorsBody": "अपना चैनल जोड़ें। Cube3 आपके दर्शकों और कंटेंट से मेल खाने वाली स्पॉन्सरशिप दिखाता है।",
		"home.forBrands": "ब्रांड्स के लिए",
		"home.forBrandsBody": "कैंपेन बनाइए। Cube3 आपके दर्शकों, कैटेगरी और ज़रूरतों से मेल खाने वाले क्रिएटर्स ढूँढता है।",
		"flow.creator": "क्रिएटर",
		"flow.brand": "ब्रांड",
		"flow.discover": "खोजें",
		"flow.apply": "आवेदन करें",
		"flow.collaborate": "साथ काम करें",
		"flow.getPaid": "भुगतान पाएँ",
		"flow.campaign": "कैंपेन",
		"flow.grow": "बढ़ें",
		"home.d1t": "आपके लिए स्पॉन्सरशिप",
		"home.d1b": "Cube3 खोलें और अपनी कैटेगरी, प्लेटफ़ॉर्म, दर्शक और भाषा से मेल खाने वाले कैंपेन देखें।",
		"home.d2t": "समझाए गए मैच",
		"home.d2b": "हर मैच स्कोर बताता है कि आप कौन-सी शर्तें पूरी करते हैं — कोई छिपा हुआ AI नंबर नहीं।",
		"home.d3t": "ईमानदार डेटा",
		"home.d3b": "सत्यापित और क्रिएटर द्वारा बताए गए आँकड़े हमेशा अलग दिखाए जाते हैं। छोटे क्रिएटर्स का स्वागत है।",
		"home.faqQ": "अपने YouTube चैनल के लिए स्पॉन्सर कैसे ढूँढें?",
		"home.faqA": "अपना चैनल जोड़ें। Cube3 आपके दर्शकों और कंटेंट से मेल खाने वाले स्पॉन्सरशिप अवसर ढूँढता है। आवेदन करें, बातचीत करें और साथ काम करें।",
		"home.getStarted": "मुफ़्त में शुरू करें",
		"footer.privacy": "गोपनीयता",
		"footer.terms": "शर्तें",
		"signin.titleCreator": "क्रिएटर के रूप में Cube3 से जुड़ें",
		"signin.titleBrand": "ब्रांड के रूप में Cube3 से जुड़ें",
		"signin.title": "Cube3 में साइन इन करें",
		"signin.sub": "कोई पासवर्ड नहीं। हम आपको एक बार का कोड ईमेल करेंगे — इससे आपका ईमेल भी सत्यापित हो जाता है।",
		"signin.agree": "आगे बढ़कर आप हमारी शर्तों और गोपनीयता नीति से सहमत होते हैं। Cube3 18+ उम्र के लोगों के लिए है।",
		"signin.email": "ईमेल",
		"signin.sendCode": "कोड भेजें",
		"signin.sending": "भेजा जा रहा है…",
		"signin.codeLabel": "{email} पर भेजा गया 6 अंकों का कोड",
		"signin.verify": "सत्यापित करें और आगे बढ़ें",
		"signin.verifying": "सत्यापित हो रहा है…",
		"signin.otherEmail": "दूसरा ईमेल इस्तेमाल करें",
		"sp.title": "स्पॉन्सरशिप खोजें",
		"sp.sub": "क्रिएटर्स की तलाश कर रहे ब्रांड्स के खुले कैंपेन।",
		"sp.forYou": "आपके लिए",
		"sp.all": "सभी कैंपेन",
		"sp.getMatched": "क्रिएटर के रूप में साइन अप करें और देखें कि कौन-से कैंपेन आपसे मेल खाते हैं — और क्यों।",
		"sp.getMatchedCta": "मैच पाएँ",
		"sp.matchCount": "{n} कैंपेन आपकी प्रोफ़ाइल से मेल खाते हैं",
		"sp.noMatches": "अभी कोई मैच नहीं",
		"sp.noMatchesBody": "मैच पाने के लिए अपनी प्रोफ़ाइल में प्लेटफ़ॉर्म और दर्शकों के आँकड़े जोड़ें।",
		"sp.completeProfile": "प्रोफ़ाइल पूरी करें →",
		"sp.search": "ब्रांड, प्रोडक्ट, जगह खोजें…",
		"sp.allCategories": "सभी कैटेगरी",
		"sp.noOpen": "कोई खुला कैंपेन नहीं मिला",
		"sp.loadMore": "और कैंपेन देखें",
		"card.view": "कैंपेन देखें",
		"card.apply": "आवेदन करें",
		"card.applied": "आवेदन किया",
		"card.whyMatch": "आप क्यों मेल खाते हैं",
		"card.match": "{n}% मैच",
		"card.audience": "{n}+ दर्शक",
		"cr.title": "क्रिएटर्स खोजें",
		"cr.sub": "छोटे और मध्यम क्रिएटर्स का स्वागत है। रैंक किए गए मैच देखने के लिए कोई कैंपेन खोलें।",
		"cr.search": "नाम, कैटेगरी, शहर, भाषा खोजें…",
		"cr.filters": "फ़िल्टर",
		"cr.none": "कोई क्रिएटर नहीं मिला",
		"cr.loadMore": "और क्रिएटर्स देखें",
		"cr.viewProfile": "प्रोफ़ाइल देखें",
		"db.sponsorshipsForYou": "आपके लिए स्पॉन्सरशिप",
		"db.seeAll": "सभी देखें →",
		"db.yourApplications": "आपके आवेदन",
		"db.noApplications": "आपने अभी तक किसी कैंपेन के लिए आवेदन नहीं किया है।",
		"db.findSponsorships": "स्पॉन्सरशिप खोजें →",
		"db.addPlatformTitle": "मैच पाने के लिए अपना YouTube या Instagram जोड़ें",
		"db.addPlatformBody": "Cube3 आपके प्लेटफ़ॉर्म, दर्शकों की संख्या और व्यूज़ के आधार पर मैच करता है।",
		"db.addPlatform": "प्लेटफ़ॉर्म जोड़ें →",
		"db.noMatchesYet": "अभी कोई मेल खाता कैंपेन नहीं",
		"db.browse": "स्पॉन्सरशिप देखें →",
		"db.brandOverview": "ब्रांड ओवरव्यू",
		"db.newCampaign": "नया कैंपेन",
		"db.yourCampaigns": "आपके कैंपेन",
		"db.firstCampaign": "आवेदन पाने के लिए अपना पहला कैंपेन बनाएँ।",
		"db.createCampaign": "कैंपेन बनाएँ →"
	},
	te: {
		"nav.home": "హోమ్",
		"nav.sponsorships": "స్పాన్సర్‌షిప్‌లు",
		"nav.creators": "క్రియేటర్లు",
		...
		"nav.language": "భాష",
		"home.h1a": "స్పాన్సర్‌షిప్‌లు కనుగొనండి. క్రియేటర్లను కనుగొనండి.",
		"home.h1b": "కలిసి పని చేయండి.",
		"home.sub": "Cube3 క్రియేటర్లకు సరైన స్పాన్సర్‌షిప్ అవకాశాలను, బ్రాండ్‌లకు వారి క్యాంపెయిన్‌లకు సరిపోయే క్రియేటర్లను కనుగొనడంలో సహాయపడుతుంది — ప్రపంచంలో ఎక్కడైనా.",
		"home.findSponsorships": "స్పాన్సర్‌షిప్‌లు కనుగొనండి",
		"home.findCreators": "క్రియేటర్లను కనుగొనండి",
		"home.imCreator": "నేను క్రియేటర్‌ని →",
		"home.imBrand": "మేము బ్రాండ్ →",
		"home.forCreators": "క్రియేటర్ల కోసం",
		"home.forCreatorsBody": "మీ ఛానల్‌ను జోడించండి. మీ ప్రేక్షకులు మరియు కంటెంట్‌కు సరిపోయే స్పాన్సర్‌షిప్‌లను Cube3 చూపిస్తుంది.",
		"home.forBrands": "బ్రాండ్‌ల కోసం",
		"home.forBrandsBody": "క్యాంపెయిన్ సృష్టించండి. మీ ప్రేక్షకులు, కేటగిరీ మరియు అవసరాలకు సరిపోయే క్రియేటర్లను Cube3 కనుగొంటుంది.",
		"flow.creator": "క్రియేటర్",
		"flow.brand": "బ్రాండ్",
		"flow.discover": "కనుగొనండి",
		"flow.apply": "దరఖాస్తు చేయండి",
		"flow.collaborate": "కలిసి పని చేయండి",
		"flow.getPaid": "చెల్లింపు పొందండి",
		"flow.campaign": "క్యాంపెయిన్",
		"flow.grow": "ఎదగండి",
		"home.d1t": "మీ కోసం స్పాన్సర్‌షిప్‌లు",
		"home.d1b": "Cube3 తెరిచి మీ కేటగిరీ, ప్లాట్‌ఫామ్, ప్రేక్షకులు మరియు భాషకు సరిపోయే క్యాంపెయిన్‌లను చూడండి.",
		"home.d2t": "వివరించిన మ్యాచ్‌లు",
		"home.d2b": "ప్రతి మ్యాచ్ స్కోర్ మీరు ఏ అవసరాలను తీరుస్తున్నారో స్పష్టంగా చూపిస్తుంది — దాచిన AI సంఖ్యలు లేవు.",
		"home.d3t": "నిజాయితీ గల డేటా",
		"home.d3b": "ధృవీకరించిన మరియు క్రియేటర్ చెప్పిన గణాంకాలు ఎప్పుడూ వేరుగా చూపబడతాయి. చిన్న క్రియేటర్లకు స్వాగతం.",
		"home.faqQ": "నా YouTube ఛానల్‌కు స్పాన్సర్‌లను ఎలా కనుగొనాలి?",
		"home.faqA": "మీ ఛానల్‌ను జోడించండి. మీ ప్రేక్షకులు మరియు కంటెంట్‌కు సరిపోయే స్పాన్సర్‌షిప్ అవకాశాలను Cube3 కనుగొంటుంది. దరఖాస్తు చేయండి, చర్చించండి, కలిసి పని చేయండి.",
		"home.getStarted": "ఉచితంగా ప్రారంభించండి",
		"footer.privacy": "గోప్యత",
		"footer.terms": "నిబంధనలు",
		"signin.titleCreator": "క్రియేటర్‌గా Cube3లో చేరండి",
		"signin.titleBrand": "బ్రాండ్‌గా Cube3లో చేరండి",
		"signin.title": "Cube3లో సైన్ ఇన్ చేయండి",
		"signin.sub": "పాస్‌వర్డ్ అవసరం లేదు. మేము మీకు ఒకసారి ఉపయోగించే కోడ్‌ను ఇమెయిల్ చేస్తాము — ఇది మీ ఇమెయిల్‌ను కూడా ధృవీకరిస్తుంది.",
		"signin.agree": "కొనసాగడం ద్వారా మీరు మా నిబంధనలు మరియు గోప్యతా విధానానికి అంగీకరిస్తున్నారు. Cube3 18 ఏళ్లు పైబడిన వారి కోసం.",
		"signin.email": "ఇమెయిల్",
		"signin.sendCode": "కోడ్ పంపండి",
		"signin.sending": "పంపుతోంది…",
		"signin.codeLabel": "{email}కి పంపిన 6 అంకెల కోడ్",
		"signin.verify": "ధృవీకరించి కొనసాగండి",
		"signin.verifying": "ధృవీకరిస్తోంది…",
		"signin.otherEmail": "వేరే ఇమెయిల్ ఉపయోగించండి",
		"sp.title": "స్పాన్సర్‌షిప్‌లు కనుగొనండి",
		"sp.sub": "క్రియేటర్ల కోసం చూస్తున్న బ్రాండ్‌ల ఓపెన్ క్యాంపెయిన్‌లు.",
		"sp.forYou": "మీ కోసం",
		"sp.all": "అన్ని క్యాంపెయిన్‌లు",
		"sp.getMatched": "క్రియేటర్‌గా సైన్ అప్ చేసి, ఏ క్యాంపెయిన్‌లు మీకు సరిపోతాయో — ఎందుకో చూడండి.",
		"sp.getMatchedCta": "మ్యాచ్‌లు పొందండి",
		"sp.matchCount": "{n} క్యాంపెయిన్‌లు మీ ప్రొఫైల్‌కు సరిపోతున్నాయి",
		"sp.noMatches": "ప్రస్తుతం మ్యాచ్‌లు లేవు",
		"sp.noMatchesBody": "మ్యాచ్‌ల కోసం మీ ప్రొఫైల్‌లో ప్లాట్‌ఫామ్‌లు మరియు ప్రేక్షకుల గణాంకాలు జోడించండి.",
		"sp.completeProfile": "ప్రొఫైల్ పూర్తి చేయండి →",
		"sp.search": "బ్రాండ్, ప్రొడక్ట్, ప్రాంతం వెతకండి…",
		"sp.allCategories": "అన్ని కేటగిరీలు",
		"sp.noOpen": "ఓపెన్ క్యాంపెయిన్‌లు లేవు",
		"sp.loadMore": "మరిన్ని క్యాంపెయిన్‌లు",
		"card.view": "క్యాంపెయిన్ చూడండి",
		"card.apply": "దరఖాస్తు చేయండి",
		"card.applied": "దరఖాస్తు చేశారు",
		"card.whyMatch": "మీరు ఎందుకు సరిపోతారు",
		"card.match": "{n}% మ్యాచ్",
		"card.audience": "{n}+ ప్రేక్షకులు",
		"cr.title": "క్రియేటర్లను కనుగొనండి",
		"cr.sub": "చిన్న మరియు మధ్యస్థ క్రియేటర్లకు స్వాగతం. ర్యాంక్ చేసిన మ్యాచ్‌ల కోసం క్యాంపెయిన్ తెరవండి.",
		"cr.search": "పేరు, కేటగిరీ, నగరం, భాష వెతకండి…",
		"cr.filters": "ఫిల్టర్లు",
		"cr.none": "క్రియేటర్లు కనబడలేదు",
		"cr.loadMore": "మరిన్ని క్రియేటర్లు",
		"cr.viewProfile": "ప్రొఫైల్ చూడండి",
		"db.sponsorshipsForYou": "మీ కోసం స్పాన్సర్‌షిప్‌లు",
		"db.seeAll": "అన్నీ చూడండి →",
		"db.yourApplications": "మీ దరఖాస్తులు",
		"db.noApplications": "మీరు ఇంకా ఏ క్యాంపెయిన్‌కూ దరఖాస్తు చేయలేదు.",
		"db.findSponsorships": "స్పాన్సర్‌షిప్‌లు కనుగొనండి →",
		"db.addPlatformTitle": "మ్యాచ్‌ల కోసం మీ YouTube లేదా Instagram జోడించండి",
		"db.addPlatformBody": "మీ ప్లాట్‌ఫామ్‌లు, ప్రేక్షకుల సంఖ్య మరియు వ్యూస్ ఆధారంగా Cube3 మ్యాచ్ చేస్తుంది.",
		"db.addPlatform": "ప్లాట్‌ఫామ్ జోడించండి →",
		"db.noMatchesYet": "ఇంకా సరిపోయే క్యాంపెయిన్‌లు లేవు",
		"db.browse": "స్పాన్సర్‌షిప్‌లు చూడండి →",
		"db.brandOverview": "బ్రాండ్ అవలోకనం",
		"db.newCampaign": "కొత్త క్యాంపెయిన్",
		"db.yourCampaigns": "మీ క్యాంపెయిన్‌లు",
		"db.firstCampaign": "దరఖాస్తులు పొందడానికి మీ మొదటి క్యాంపెయిన్ సృష్టించండి.",
		"db.createCampaign": "క్యాంపెయిన్ సృష్టించండి →"
	},
	ta: {
		"nav.home": "முகப்பு",
		"nav.sponsorships": "ஸ்பான்சர்ஷிப்கள்",
		"nav.creators": "கிரியேட்டர்கள்",
		"nav.inbox": "இன்பாக்ஸ்",
		...
		"nav.language": "மொழி",
		"home.h1a": "ஸ்பான்சர்ஷிப்களைக் கண்டறியுங்கள். கிரியேட்டர்களைக் கண்டறியுங்கள்.",
		"home.h1b": "இணைந்து செயல்படுங்கள்.",
		"home.sub": "Cube3 கிரியேட்டர்களுக்குப் பொருத்தமான ஸ்பான்சர்ஷிப் வாய்ப்புகளையும், பிராண்டுகளுக்கு அவர்களின் கேம்பெயின்களுக்கு ஏற்ற கிரியேட்டர்களையும் கண்டறிய உதவுகிறது — உலகில் எங்கிருந்தாலும்.",
		"home.findSponsorships": "ஸ்பான்சர்ஷிப்களைக் கண்டறியுங்கள்",
		"home.findCreators": "கிரியேட்டர்களைக் கண்டறியுங்கள்",
		"home.imCreator": "நான் ஒரு கிரியேட்டர் →",
		"home.imBrand": "நாங்கள் ஒரு பிராண்ட் →",
		"home.forCreators": "கிரியேட்டர்களுக்கு",
		"home.forCreatorsBody": "உங்கள் சேனலை இணைக்கவும். உங்கள் பார்வையாளர்கள் மற்றும் உள்ளடக்கத்துக்குப் பொருந்தும் ஸ்பான்சர்ஷிப்களை Cube3 காட்டும்.",
		"home.forBrands": "பிராண்டுகளுக்கு",
		"home.forBrandsBody": "கேம்பெயின் உருவாக்குங்கள். உங்கள் பார்வையாளர்கள், பிரிவு மற்றும் தேவைகளுக்கு ஏற்ற கிரியேட்டர்களை Cube3 கண்டறியும்.",
		"flow.creator": "கிரியேட்டர்",
		"flow.brand": "பிராண்ட்",
		"flow.discover": "கண்டறியுங்கள்",
		"flow.apply": "விண்ணப்பியுங்கள்",
		"flow.collaborate": "இணைந்து செயல்படுங்கள்",
		"flow.getPaid": "பணம் பெறுங்கள்",
		"flow.campaign": "கேம்பெயின்",
		"flow.grow": "வளருங்கள்",
		"home.d1t": "உங்களுக்கான ஸ்பான்சர்ஷிப்கள்",
		"home.d1b": "Cube3-ஐத் திறந்து உங்கள் பிரிவு, தளம், பார்வையாளர்கள் மற்றும் மொழிக்குப் பொருந்தும் கேம்பெயின்களைப் பாருங்கள்.",
		"home.d2t": "விளக்கப்பட்ட பொருத்தங்கள்",
		"home.d2b": "ஒவ்வொரு பொருத்த மதிப்பெண்ணும் நீங்கள் எந்தத் தேவைகளைப் பூர்த்தி செய்கிறீர்கள் என்பதைக் காட்டும் — மறைந்த AI எண்கள் இல்லை.",
		"home.d3t": "நேர்மையான தரவு",
		"home.d3b": "சரிபார்க்கப்பட்ட மற்றும் கிரியேட்டர் தெரிவித்த புள்ளிவிவரங்கள் எப்போதும் தனித்தனியாகக் காட்டப்படும். சிறிய கிரியேட்டர்களுக்கு வரவேற்பு.",
		"home.faqQ": "என் YouTube சேனலுக்கு ஸ்பான்சர்களை எப்படிக் கண்டறிவது?",
		"home.faqA": "உங்கள் சேனலைச் சேர்க்கவும். உங்கள் பார்வையாளர்கள் மற்றும் உள்ளடக்கத்துக்குப் பொருந்தும் வாய்ப்புகளை Cube3 கண்டறியும். விண்ணப்பியுங்கள், பேசுங்கள், இணைந்து செயல்படுங்கள்.",
		"home.getStarted": "இலவசமாகத் தொடங்குங்கள்",
		"footer.privacy": "தனியுரிமை",
		"footer.terms": "விதிமுறைகள்",
		"signin.titleCreator": "கிரியேட்டராக Cube3-இல் சேருங்கள்",
		"signin.titleBrand": "பிராண்டாக Cube3-இல் சேருங்கள்",
		"signin.title": "Cube3-இல் உள்நுழையுங்கள்",
		"signin.sub": "கடவுச்சொல் தேவையில்லை. ஒருமுறை பயன்படுத்தும் குறியீட்டை மின்னஞ்சலில் அனுப்புவோம் — இது உங்கள் மின்னஞ்சலையும் சரிபார்க்கும்.",
		"signin.agree": "தொடர்வதன் மூலம் எங்கள் விதிமுறைகள் மற்றும் தனியுரிமைக் கொள்கையை ஏற்கிறீர்கள். Cube3 18 வயதுக்கு மேற்பட்டவர்களுக்கானது.",
		"signin.email": "மின்னஞ்சல்",
		"signin.sendCode": "குறியீட்டை அனுப்பு",
		"signin.sending": "அனுப்புகிறது…",
		"signin.codeLabel": "{email}-க்கு அனுப்பப்பட்ட 6 இலக்கக் குறியீடு",
		"signin.verify": "சரிபார்த்துத் தொடரவும்",
		"signin.verifying": "சரிபார்க்கிறது…",
		"signin.otherEmail": "வேறு மின்னஞ்சலைப் பயன்படுத்து",
		"sp.title": "ஸ்பான்சர்ஷிப்களைக் கண்டறியுங்கள்",
		"sp.sub": "கிரியேட்டர்களைத் தேடும் பிராண்டுகளின் திறந்த கேம்பெயின்கள்.",
		"sp.forYou": "உங்களுக்கு",
		"sp.all": "அனைத்து கேம்பெயின்கள்",
		"sp.getMatched": "கிரியேட்டராகப் பதிவு செய்து, எந்தக் கேம்பெயின்கள் உங்களுக்குப் பொருந்தும் — ஏன் என்று பாருங்கள்.",
		"sp.getMatchedCta": "பொருத்தங்களைப் பெறுங்கள்",
		"sp.matchCount": "{n} கேம்பெயின்கள் உங்கள் சுயவிவரத்துக்குப் பொருந்துகின்றன",
		"sp.noMatches": "இப்போது பொருத்தங்கள் இல்லை",
		"sp.noMatchesBody": "பொருத்தங்களுக்கு உங்கள் சுயவிவரத்தில் தளங்கள் மற்றும் பார்வையாளர் புள்ளிவிவரங்களைச் சேர்க்கவும்.",
		"sp.completeProfile": "சுயவிவரத்தை நிறைவு செய்யுங்கள் →",
		"sp.search": "பிராண்ட், பொருள், இடம் தேடுங்கள்…",
		"sp.allCategories": "அனைத்து பிரிவுகள்",
		"sp.noOpen": "திறந்த கேம்பெயின்கள் இல்லை",
		"sp.loadMore": "மேலும் கேம்பெயின்கள்",
		"card.view": "கேம்பெயினைப் பாருங்கள்",
		"card.apply": "விண்ணப்பியுங்கள்",
		"card.applied": "விண்ணப்பித்தீர்கள்",
		"card.whyMatch": "நீங்கள் ஏன் பொருந்துகிறீர்கள்",
		"card.match": "{n}% பொருத்தம்",
		"card.audience": "{n}+ பார்வையாளர்கள்",
		"cr.title": "கிரியேட்டர்களைக் கண்டறியுங்கள்",
		"cr.sub": "சிறிய மற்றும் நடுத்தர கிரியேட்டர்களுக்கு வரவேற்பு. தரவரிசைப் பொருத்தங்களுக்கு ஒரு கேம்பெயினைத் திறக்கவும்.",
		"cr.search": "பெயர், பிரிவு, நகரம், மொழி தேடுங்கள்…",
		"cr.filters": "வடிகட்டிகள்",
		"cr.none": "கிரியேட்டர்கள் இல்லை",
		"cr.loadMore": "மேலும் கிரியேட்டர்கள்",
		"cr.viewProfile": "சுயவிவரம் பாருங்கள்",
		"db.sponsorshipsForYou": "உங்களுக்கான ஸ்பான்சர்ஷிப்கள்",
		"db.seeAll": "அனைத்தையும் பாருங்கள் →",
		"db.yourApplications": "உங்கள் விண்ணப்பங்கள்",
		"db.noApplications": "நீங்கள் இன்னும் எந்தக் கேம்பெயினுக்கும் விண்ணப்பிக்கவில்லை.",
		"db.findSponsorships": "ஸ்பான்சர்ஷிப்களைக் கண்டறியுங்கள் →",
		"db.addPlatformTitle": "பொருத்தங்களுக்கு உங்கள் YouTube அல்லது Instagram-ஐச் சேர்க்கவும்",
		"db.addPlatformBody": "உங்கள் தளங்கள், பார்வையாளர் எண்ணிக்கை மற்றும் பார்வைகளின் அடிப்படையில் Cube3 பொருத்துகிறது.",
		"db.addPlatform": "தளத்தைச் சேர்க்கவும் →",
		"db.noMatchesYet": "இன்னும் பொருந்தும் கேம்பெயின்கள் இல்லை",
		"db.browse": "ஸ்பான்சர்ஷிப்களைப் பாருங்கள் →",
		"db.brandOverview": "பிராண்ட் கண்ணோட்டம்",
		"db.newCampaign": "புதிய கேம்பெயின்",
		"db.yourCampaigns": "உங்கள் கேம்பெயின்கள்",
		"db.firstCampaign": "விண்ணப்பங்களைப் பெற உங்கள் முதல் கேம்பெயினை உருவாக்குங்கள்.",
		"db.createCampaign": "கேம்பெயின் உருவாக்குங்கள் →"
	},
	es: {
		"nav.home": "Inicio",
		"nav.sponsorships": "Patrocinios",
		...
		"nav.language": "Idioma",
		"home.h1a": "Encuentra patrocinios. Encuentra creadores.",
		"home.h1b": "Crea colaboraciones.",
		"home.sub": "Cube3 ayuda a los creadores a descubrir patrocinios relevantes y a las marcas a encontrar creadores que encajan con sus campañas, en cualquier parte del mundo.",
		"home.findSponsorships": "Buscar patrocinios",
		"home.findCreators": "Buscar creadores",
		"home.imCreator": "Soy creador →",
		"home.imBrand": "Soy una marca →",
		"home.forCreators": "Para creadores",
		"home.forCreatorsBody": "Conecta tu canal. Cube3 te muestra patrocinios que encajan con tu audiencia y tu contenido.",
		"home.forBrands": "Para marcas",
		"home.forBrandsBody": "Crea una campaña. Cube3 encuentra creadores que encajan con tu audiencia, categoría y requisitos.",
		"flow.creator": "Creador",
		"flow.brand": "Marca",
		"flow.discover": "Descubre",
		"flow.apply": "Postúlate",
		"flow.collaborate": "Colabora",
		"flow.getPaid": "Cobra",
		"flow.campaign": "Campaña",
		"flow.grow": "Crece",
		"home.d1t": "Patrocinios para ti",
		"home.d1b": "Abre Cube3 y ve campañas que encajan con tu categoría, plataforma, audiencia e idioma.",
		"home.d2t": "Coincidencias explicadas",
		"home.d2b": "Cada puntuación muestra exactamente qué requisitos cumples, sin números opacos de IA.",
		"home.d3t": "Datos honestos",
		"home.d3b": "Las estadísticas verificadas y las declaradas por el creador siempre se muestran por separado. Creadores pequeños, bienvenidos.",
		"home.faqQ": "¿Cómo encuentro patrocinadores para mi canal de YouTube?",
		"home.faqA": "Añade tu canal. Cube3 encuentra oportunidades de patrocinio que encajan con tu audiencia y contenido. Postúlate, negocia y colabora.",
		"home.getStarted": "Empieza gratis",
		"footer.privacy": "Privacidad",
		"footer.terms": "Términos",
		"signin.titleCreator": "Únete a Cube3 como creador",
		"signin.titleBrand": "Únete a Cube3 como marca",
		"signin.title": "Inicia sesión en Cube3",
		"signin.sub": "Sin contraseñas. Te enviaremos un código de un solo uso por correo; así también verificamos tu email.",
		"signin.agree": "Al continuar aceptas nuestros Términos y nuestra Política de privacidad. Cube3 es para mayores de 18 años.",
		"signin.email": "Correo electrónico",
		"signin.sendCode": "Enviar código",
		"signin.sending": "Enviando…",
		"signin.codeLabel": "Código de 6 dígitos enviado a {email}",
		"signin.verify": "Verificar y continuar",
		"signin.verifying": "Verificando…",
		"signin.otherEmail": "Usar otro correo",
		"sp.title": "Buscar patrocinios",
		"sp.sub": "Campañas abiertas de marcas que buscan creadores.",
		"sp.forYou": "Para ti",
		"sp.all": "Todas las campañas",
		"sp.getMatched": "Regístrate como creador para ver qué campañas encajan contigo, y por qué.",
		"sp.getMatchedCta": "Ver coincidencias",
		"sp.matchCount": "{n} campañas encajan con tu perfil",
		"sp.noMatches": "No hay coincidencias por ahora",
		"sp.noMatchesBody": "Añade plataformas y estadísticas de audiencia a tu perfil para ver coincidencias.",
		"sp.completeProfile": "Completar perfil →",
		"sp.search": "Busca marca, producto, ubicación…",
		"sp.allCategories": "Todas las categorías",
		"sp.noOpen": "No hay campañas abiertas",
		"sp.loadMore": "Cargar más campañas",
		"card.view": "Ver campaña",
		"card.apply": "Postularme",
		"card.applied": "Postulado",
		"card.whyMatch": "Por qué encajas",
		"card.match": "{n}% de coincidencia",
		"card.audience": "{n}+ de audiencia",
		"cr.title": "Buscar creadores",
		"cr.sub": "Creadores pequeños y medianos, bienvenidos. Abre una campaña para ver coincidencias ordenadas.",
		"cr.search": "Busca nombre, categoría, ciudad, idioma…",
		"cr.filters": "Filtros",
		"cr.none": "No se encontraron creadores",
		"cr.loadMore": "Cargar más creadores",
		"cr.viewProfile": "Ver perfil",
		"db.sponsorshipsForYou": "Patrocinios para ti",
		"db.seeAll": "Ver todo →",
		"db.yourApplications": "Tus postulaciones",
		"db.noApplications": "Aún no te has postulado a ninguna campaña.",
		"db.findSponsorships": "Buscar patrocinios →",
		"db.addPlatformTitle": "Añade tu YouTube o Instagram para recibir coincidencias",
		"db.addPlatformBody": "Cube3 te empareja según tus plataformas, tamaño de audiencia y vistas.",
		"db.addPlatform": "Añadir plataforma →",
		"db.noMatchesYet": "Aún no hay campañas que encajen",
		"db.browse": "Ver patrocinios →",
		"db.brandOverview": "Resumen de la marca",
		"db.newCampaign": "Nueva campaña",
		"db.yourCampaigns": "Tus campañas",
		"db.firstCampaign": "Crea tu primera campaña para empezar a recibir postulaciones.",
		"db.createCampaign": "Crear campaña →"
	},
	pt: {
		"nav.home": "Início",
		"nav.sponsorships": "Patrocínios",
		"nav.creators": "Criadores",
		"nav.inbox": "Mensagens",
		"nav.profile": "Perfil",
		"nav.signIn": "Entrar",
		"nav.join": "Cadastre-se",
		"nav.signOut": "Sair",
		"nav.language": "Idioma",
		"home.h1a": "Encontre patrocínios. Encontre criadores.",
		"home.h1b": "Crie parcerias.",
		"home.sub": "O Cube3 ajuda criadores a descobrir patrocínios relevantes e marcas a encontrar criadores que combinam com suas campanhas, em qualquer lugar do mundo.",
		"home.findSponsorships": "Encontrar patrocínios",
		"home.findCreators": "Encontrar criadores",
		"home.imCreator": "Sou criador →",
		"home.imBrand": "Sou uma marca →",
		"home.forCreators": "Para criadores",
		"home.forCreatorsBody": "Conecte seu canal. O Cube3 mostra patrocínios que combinam com seu público e seu conteúdo.",
		"home.forBrands": "Para marcas",
		"home.forBrandsBody": "Crie uma campanha. O Cube3 encontra criadores que combinam com seu público, categoria e requisitos.",
		"flow.creator": "Criador",
		"flow.brand": "Marca",
		"flow.discover": "Descubra",
		"flow.apply": "Candidate-se",
		"flow.collaborate": "Colabore",
		"flow.getPaid": "Receba",
		"flow.campaign": "Campanha",
		"flow.grow": "Cresça",
		"home.d1t": "Patrocínios para você",
		"home.d1b": "Abra o Cube3 e veja campanhas que combinam com sua categoria, plataforma, público e idioma.",
		"home.d2t": "Correspondências explicadas",
		"home.d2b": "Cada pontuação mostra exatamente quais requisitos você atende, sem números de IA misteriosos.",
		"home.d3t": "Dados honestos",
		"home.d3b": "Estatísticas verificadas e informadas pelo criador são sempre mostradas separadamente. Pequenos criadores são bem-vindos.",
		"home.faqQ": "Como encontro patrocinadores para meu canal no YouTube?",
		"home.faqA": "Adicione seu canal. O Cube3 encontra oportunidades de patrocínio que combinam com seu público e conteúdo. Candidate-se, negocie e colabore.",
		"home.getStarted": "Comece grátis",
		"footer.privacy": "Privacidade",
		"footer.terms": "Termos",
		"signin.titleCreator": "Entre no Cube3 como criador",
		"signin.titleBrand": "Entre no Cube3 como marca",
		"signin.title": "Entrar no Cube3",
		"signin.sub": "Sem senhas. Enviaremos um código de uso único por e-mail, o que também verifica seu e-mail.",
		"signin.agree": "Ao continuar, você concorda com nossos Termos e nossa Política de Privacidade. O Cube3 é para maiores de 18 anos.",
		"signin.email": "E-mail",
		"signin.sendCode": "Enviar código",
		"signin.sending": "Enviando…",
		"signin.codeLabel": "Código de 6 dígitos enviado para {email}",
		"signin.verify": "Verificar e continuar",
		"signin.verifying": "Verificando…",
		"signin.otherEmail": "Usar outro e-mail",
		"sp.title": "Encontrar patrocínios",
		"sp.sub": "Campanhas abertas de marcas procurando criadores.",
		"sp.forYou": "Para você",
		"sp.all": "Todas as campanhas",
		"sp.getMatched": "Cadastre-se como criador para ver quais campanhas combinam com você, e por quê.",
		"sp.getMatchedCta": "Ver correspondências",
		"sp.matchCount": "{n} campanhas combinam com seu perfil",
		"sp.noMatches": "Nenhuma correspondência no momento",
		"sp.noMatchesBody": "Adicione plataformas e estatísticas de público ao seu perfil para ver correspondências.",
		"sp.completeProfile": "Completar perfil →",
		"sp.search": "Busque marca, produto, local…",
		"sp.allCategories": "Todas as categorias",
		"sp.noOpen": "Nenhuma campanha aberta",
		"sp.loadMore": "Carregar mais campanhas",
		"card.view": "Ver campanha",
		"card.apply": "Candidatar-se",
		"card.applied": "Candidatado",
		"card.whyMatch": "Por que você combina",
		"card.match": "{n}% de correspondência",
		"card.audience": "{n}+ de público",
		"cr.title": "Encontrar criadores",
		"cr.sub": "Criadores pequenos e médios são bem-vindos. Abra uma campanha para ver correspondências classificadas.",
		"cr.search": "Busque nome, categoria, cidade, idioma…",
		"cr.filters": "Filtros",
		"cr.none": "Nenhum criador encontrado",
		"cr.loadMore": "Carregar mais criadores",
		"cr.viewProfile": "Ver perfil",
		"db.sponsorshipsForYou": "Patrocínios para você",
		"db.seeAll": "Ver tudo →",
		"db.yourApplications": "Suas candidaturas",
		"db.noApplications": "Você ainda não se candidatou a nenhuma campanha.",
		"db.findSponsorships": "Encontrar patrocínios →",
		"db.addPlatformTitle": "Adicione seu YouTube ou Instagram para receber correspondências",
		"db.addPlatformBody": "O Cube3 combina você pelas suas plataformas, tamanho do público e visualizações.",
		"db.addPlatform": "Adicionar plataforma →",
		"db.noMatchesYet": "Ainda não há campanhas compatíveis",
		"db.browse": "Ver patrocínios →",
		"db.brandOverview": "Visão geral da marca",
		"db.newCampaign": "Nova campanha",
		"db.yourCampaigns": "Suas campanhas",
		"db.firstCampaign": "Crie sua primeira campanha para começar a receber candidaturas.",
		"db.createCampaign": "Criar campanha →"
	},
	id: {
		"nav.home": "Beranda",
		"nav.sponsorships": "Sponsor",
		...
		"nav.signOut": "Keluar",
		"nav.language": "Bahasa",
		"home.h1a": "Temukan sponsor. Temukan kreator.",
		"home.h1b": "Bangun kolaborasi.",
		"home.sub": "Cube3 membantu kreator menemukan peluang sponsor yang relevan dan membantu brand menemukan kreator yang cocok dengan kampanye mereka — di mana pun di dunia.",
		"home.findSponsorships": "Cari sponsor",
		"home.findCreators": "Cari kreator",
		"home.imCreator": "Saya kreator →",
		"home.imBrand": "Kami brand →",
		"home.forCreators": "Untuk kreator",
		"home.forCreatorsBody": "Hubungkan channel Anda. Cube3 menampilkan sponsor yang cocok dengan audiens dan konten Anda.",
		"home.forBrands": "Untuk brand",
		"home.forBrandsBody": "Buat kampanye. Cube3 menemukan kreator yang cocok dengan audiens, kategori, dan kebutuhan Anda.",
		"flow.creator": "Kreator",
		"flow.brand": "Brand",
		"flow.discover": "Temukan",
		"flow.apply": "Lamar",
		"flow.collaborate": "Kolaborasi",
		"flow.getPaid": "Dibayar",
		"flow.campaign": "Kampanye",
		"flow.grow": "Berkembang",
		"home.d1t": "Sponsor untuk Anda",
		"home.d1b": "Buka Cube3 dan lihat kampanye yang cocok dengan kategori, platform, audiens, dan bahasa Anda.",
		"home.d2t": "Kecocokan yang dijelaskan",
		"home.d2b": "Setiap skor menunjukkan persyaratan mana yang Anda penuhi — tanpa angka AI yang misterius.",
		"home.d3t": "Data yang jujur",
		"home.d3b": "Statistik terverifikasi dan yang dilaporkan kreator selalu ditampilkan terpisah. Kreator kecil dipersilakan.",
		"home.faqQ": "Bagaimana cara mencari sponsor untuk channel YouTube saya?",
		"home.faqA": "Tambahkan channel Anda. Cube3 menemukan peluang sponsor yang cocok dengan audiens dan konten Anda. Lamar, negosiasi, dan berkolaborasi.",
		"home.getStarted": "Mulai gratis",
		"footer.privacy": "Privasi",
		"footer.terms": "Ketentuan",
		"signin.titleCreator": "Bergabung ke Cube3 sebagai kreator",
		"signin.titleBrand": "Bergabung ke Cube3 sebagai brand",
		"signin.title": "Masuk ke Cube3",
		"signin.sub": "Tanpa kata sandi. Kami akan mengirim kode sekali pakai ke email Anda — sekaligus memverifikasi email Anda.",
		"signin.agree": "Dengan melanjutkan, Anda menyetujui Ketentuan dan Kebijakan Privasi kami. Cube3 untuk usia 18+.",
		"signin.email": "Email",
		"signin.sendCode": "Kirim kode",
		"signin.sending": "Mengirim…",
		"signin.codeLabel": "Kode 6 digit dikirim ke {email}",
		"signin.verify": "Verifikasi & lanjutkan",
		"signin.verifying": "Memverifikasi…",
		"signin.otherEmail": "Gunakan email lain",
		"sp.title": "Cari sponsor",
		"sp.sub": "Kampanye terbuka dari brand yang mencari kreator.",
		"sp.forYou": "Untuk Anda",
		"sp.all": "Semua kampanye",
		"sp.getMatched": "Daftar sebagai kreator untuk melihat kampanye mana yang cocok untuk Anda — dan alasannya.",
		"sp.getMatchedCta": "Lihat kecocokan",
		"sp.matchCount": "{n} kampanye cocok dengan profil Anda",
		"sp.noMatches": "Belum ada kecocokan",
		"sp.noMatchesBody": "Tambahkan platform dan statistik audiens ke profil Anda untuk mendapatkan kecocokan.",
		"sp.completeProfile": "Lengkapi profil →",
		"sp.search": "Cari brand, produk, lokasi…",
		"sp.allCategories": "Semua kategori",
		"sp.noOpen": "Tidak ada kampanye terbuka",
		"sp.loadMore": "Muat lebih banyak kampanye",
		"card.view": "Lihat kampanye",
		"card.apply": "Lamar",
		"card.applied": "Sudah melamar",
		"card.whyMatch": "Mengapa Anda cocok",
		"card.match": "{n}% cocok",
		"card.audience": "{n}+ audiens",
		"cr.title": "Cari kreator",
		"cr.sub": "Kreator kecil dan menengah dipersilakan. Buka kampanye untuk melihat kecocokan yang diurutkan.",
		"cr.search": "Cari nama, kategori, kota, bahasa…",
		"cr.filters": "Filter",
		"cr.none": "Kreator tidak ditemukan",
		"cr.loadMore": "Muat lebih banyak kreator",
		"cr.viewProfile": "Lihat profil",
		"db.sponsorshipsForYou": "Sponsor untuk Anda",
		"db.seeAll": "Lihat semua →",
		"db.yourApplications": "Lamaran Anda",
		"db.noApplications": "Anda belum melamar kampanye apa pun.",
		"db.findSponsorships": "Cari sponsor →",
		"db.addPlatformTitle": "Tambahkan YouTube atau Instagram Anda untuk mendapat kecocokan",
		"db.addPlatformBody": "Cube3 mencocokkan Anda berdasarkan platform, jumlah audiens, dan tayangan.",
		"db.addPlatform": "Tambah platform →",
		"db.noMatchesYet": "Belum ada kampanye yang cocok",
		"db.browse": "Lihat sponsor →",
		"db.brandOverview": "Ringkasan brand",
		"db.newCampaign": "Kampanye baru",
		"db.yourCampaigns": "Kampanye Anda",
		"db.firstCampaign": "Buat kampanye pertama Anda untuk mulai menerima lamaran.",
		"db.createCampaign": "Buat kampanye →"
	}
};
//#endregion
//#region src/lib/i18n.tsx
var STORAGE_KEY = "cube3.lang";
...
function detect() {
	...
	return UI_LANGUAGES.find((l) => l.code === nav)?.code ?? "en";
}
function I18nProvider({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(I18nContext.Provider, {
		"data-macaly-loc": "src/lib/i18n.tsx:55:9",
		"data-macaly-name": "I18nContext.Provider",
		value,
		children
	});
}
...
function Button({ className, variant = "default", size = "default", asChild = false, ...props }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(asChild ? Slot : "button", {
		"data-macaly-loc": "src/components/ui/button.tsx:54:4",
...
//#endregion
export { findRouteMatch as $, Link as A, reactUse as B, ConvexHttpClient as C, __toESM as Ct, convexToJson as D, ConvexError as E, useRouter as F, interpolatePath as G, usePrevious as H, routerContext as I, trimPath as J, joinPaths as K, ClientOnly as L, useStructuralSharing as M, useStore as N, jsonToConvex as O, matchContext as P, findFlatMatch as Q, useHydrated as R, useQuery as S, __commonJSMin as St, makeFunctionReference as T, cleanPath as U, useLayoutEffect as V, compileDecodeCharMap as W, trimPathRight as X, trimPathLeft as Y, buildRouteBranch as Z, useQueries as _, last as _t, useComposedRefs as a, DEFAULT_PROTOCOL_ALLOWLIST as at, useConvex as b, require_react_dom as bt, I18nProvider as c, decodePath as ct, UI_LANGUAGES as d, escapeHtml as dt, findSingleMatch as et, Users as f, functionalUpdate as ft, useAuthActions as g, isPromise as gt, ConvexAuthProvider as h, isModuleNotFoundError as ht, createSlot as i, invariant as it, useMatch as j, validateDeploymentUrl as k, useI18n as l, deepEqual as lt, createLucideIcon as m, isDangerousProtocol as mt, cn as n, processRouteTree as nt, cva as o, arraysEqual as ot, CalendarDays as p, hasKeys as pt, resolvePath as q, Slot as r, createLRUCache as rt, api as s, createControlledPromise as st, Button as t, processRouteMasks as tt, useT as u, encodePathLikeUrl as ut, ConvexReactClient as v, nullReplaceEqualDeep as vt, getFunctionName as w, useMutation as x, require_react as xt, useAction as y, replaceEqualDeep as yt, require_jsx_runtime as z };
